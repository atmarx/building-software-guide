...
### Alex Birsan Dependency Confusion Research {#birsan-dependency-confusion}
...
### BadNets: ML Model Supply Chain {#ml-security}

Gu, Tianyu et al. "BadNets: Identifying Vulnerabilities in the Machine Learning Model Supply Chain." December 2017.
https://arxiv.org/abs/1708.06733

### Boring Technology {#boring-technology}

McKinley, Dan. "Choose Boring Technology." March 2015.
https://mcfunley.com/choose-boring-technology

## C

### CISA Software Supply Chain Security Guidance {#cisa-supply-chain}
...
### CycloneDX Specification {#cyclonedx}
...
### event-stream Incident {#event-stream}
...
### Extracting Training Data from LLMs {#ml-privacy}
...
Peng, Roger D. "Reproducible Research in Computational Science." Science. December 2011.
...
### Typosquatting Research {#typosquatting-research}
...
### ua-parser-js Incident {#ua-parser-js}
...
### xz Utils Backdoor Analysis {#xz-utils-analysis}
...
2. Use descriptive headers in Title Case with anchor ID: `### Title {#anchor-id}`
3. Provide author, title, publication/organization, and date where available
4. Include URL to primary source
...
[^left-pad]: See [left-pad Incident](../reference/sources.md#left-pad)
```
